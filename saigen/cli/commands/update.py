...
@click.option(
    "--force-update", is_flag=True, help="Regenerate the file completely, ignoring existing content"
)
@click.option(
    "--merge-strategy",
...
@click.option("--interactive", is_flag=True, help="Prompt for conflict resolution interactively")
@click.pass_context
def update(
    ctx: click.Context,
    saidata_file: Path,
    ...
    try:
        ...
        from ...models.generation import GenerationMode, GenerationRequest, LLMProvider
