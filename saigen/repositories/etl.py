...
from saigen.models.saidata import (
    SaiData, Metadata, Package, ProviderConfig, Repository, 
    RepositoryType, Urls, PackageSource
)
...
class RepositoryToSaidataETL:
    ...
    async def extract_packages(self, software_name: str, 
                             platforms: Optional[List[str]] = None) -> Dict[str, List[RepositoryPackage]]:
        ...
        search_result = await self.repository_manager.search_packages(
            query=software_name,
            platform=None  # Search all platforms initially
        )
    ...
    def transform_packages_to_saidata(self, software_name: str, 
                                    packages_by_repo: Dict[str, List[RepositoryPackage]],
                                    additional_metadata: Optional[Dict[str, Any]] = None) -> SaiData:
        ...
        # Build metadata
        metadata_dict = self._build_metadata_dict(primary_package, packages_by_repo, additional_metadata)
    ...
    def _select_primary_package(self, packages_by_repo: Dict[str, List[RepositoryPackage]]) -> Optional[RepositoryPackage]:
    ...
    def _create_provider_config_from_packages(self, repo_type: str, 
                                            packages: List[RepositoryPackage]) -> Optional[ProviderConfig]:
    ...
    def _build_metadata_dict(self, primary_package: Optional[RepositoryPackage],
                           packages_by_repo: Dict[str, List[RepositoryPackage]],
    ...
    async def process_software(self, software_name: str, 
                             output_path: Path,
                             platforms: Optional[List[str]] = None,
                             additional_metadata: Optional[Dict[str, Any]] = None,
                             format: str = 'yaml') -> SaiData:
    ...
    async def batch_process(self, software_list: List[str],
                          output_dir: Path,
                          platforms: Optional[List[str]] = None,
                          format: str = 'yaml') -> Dict[str, bool]:
