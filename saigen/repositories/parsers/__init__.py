...
async def parse_json_format(content: str, config: Dict[str, Any], 
                          repository_info: RepositoryInfo) -> List[RepositoryPackage]:
...
async def parse_yaml_format(content: str, config: Dict[str, Any], 
                          repository_info: RepositoryInfo) -> List[RepositoryPackage]:
...
async def parse_xml_format(content: str, config: Dict[str, Any], 
                         repository_info: RepositoryInfo) -> List[RepositoryPackage]:
...
async def parse_text_format(content: str, config: Dict[str, Any], 
                          repository_info: RepositoryInfo) -> List[RepositoryPackage]:
...
async def parse_debian_packages(content: str, config: Dict[str, Any], 
                              repository_info: RepositoryInfo) -> List[RepositoryPackage]:
...
async def parse_rpm_metadata(content: str, config: Dict[str, Any], 
                           repository_info: RepositoryInfo) -> List[RepositoryPackage]:
...
async def parse_html_format(content: str, config: Dict[str, Any], 
                          repository_info: RepositoryInfo) -> List[RepositoryPackage]:
...
async def parse_csv_format(content: str, config: Dict[str, Any], 
                         repository_info: RepositoryInfo) -> List[RepositoryPackage]:
...
async def parse_tsv_format(content: str, config: Dict[str, Any], 
                         repository_info: RepositoryInfo) -> List[RepositoryPackage]:
...
def extract_packages_from_data(data: Any, config: Dict[str, Any], 
                             repository_info: RepositoryInfo, format_type: str) -> List[RepositoryPackage]:
...
def extract_packages_from_xml(root: ET.Element, config: Dict[str, Any], 
                            repository_info: RepositoryInfo) -> List[RepositoryPackage]:
...
def get_xml_field(element: ET.Element, field_config: str, default: Optional[str] = None) -> Optional[str]:
...
def create_package_from_debian_fields(fields: Dict[str, str], 
                                    repository_info: RepositoryInfo) -> Optional[RepositoryPackage]:
...
def create_package_from_rpm_element(element: ET.Element, 
                                  repository_info: RepositoryInfo) -> Optional[RepositoryPackage]:
