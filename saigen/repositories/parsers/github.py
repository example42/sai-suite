...
async def parse_github_directory(content: str, config: Dict[str, Any], 
...
async def parse_github_directory_with_details(content: str, config: Dict[str, Any], 
                                             repository_info: RepositoryInfo,
                                             fetch_details: bool = False) -> List[RepositoryPackage]:
