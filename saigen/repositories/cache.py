...
from saigen.models.repository import RepositoryPackage, CacheEntry, RepositoryInfo
...
class RepositoryCache:
    ...
    async def set(self, cache_key: str, packages: List[RepositoryPackage], 
                  repository_name: str, ttl: Optional[timedelta] = None,
    ...
    async def get_or_fetch(self, downloader: BaseRepositoryDownloader) -> List[RepositoryPackage]:
        ...
        try:
            ...
            raise CacheError(f"Failed to fetch data for {downloader.repository_info.name}: {str(e)}")
...
class CacheManager:
    ...
    async def update_repository(self, downloader: BaseRepositoryDownloader, force: bool = False) -> bool:
    ...
    async def update_all_repositories(self, downloaders: List[BaseRepositoryDownloader], 
