...
- [ ] 1. Update data models for schema 0.3 support
...
- [ ] 1.1 Update Package model in sai/models/saidata.py
...
- [ ] 1.2 Create Source model in sai/models/saidata.py
...
- [ ] 1.3 Create Binary model in sai/models/saidata.py
...
- [ ] 1.4 Create Script model in sai/models/saidata.py
...
- [ ] 1.5 Update ProviderConfig and SaiData models
...
- [ ] 2. Update schema validation for 0.3 format
...
- [ ] 2.1 Update schema loading in sai/core/saidata_loader.py
...
- [ ] 2.2 Update package validation in sai/core/saidata_loader.py
...
- [ ] 2.3 Add validation for new resource types
...
- [ ] 3. Update template engine for new function signatures
...
- [ ] 3.1 Update sai_package function signature
...
- [ ] 3.2 Update context builder for new arrays
...
- [ ] 3.3 Add new template functions
...
- [ ] 4.1 Check source provider implementation
...
- [ ] 4.2 Check binary provider implementation
...
- [ ] 4.3 Check script provider implementation
...
- [ ]* 5.3 Write template engine unit tests
...
- [ ]* 6.2 Create example saidata files
