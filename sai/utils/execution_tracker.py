...
class ExecutionResult:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        result_dict['commands'] = [cmd.to_dict() if hasattr(cmd, 'to_dict') else cmd 
...
class ExecutionTracker:
    ...
    def start_execution(self, action: str, software: str, provider: str,
        ...
        # Log execution start
        self.logger.log_execution_start(action, software, provider, {
            'execution_id': execution_id,
            'dry_run': dry_run,
            'timeout': timeout
        })
    ...
    def add_command_result(self, execution_id: str, command: str, exit_code: int,
                          stdout: str, stderr: str, execution_time: float) -> None:
    ...
    def finish_execution(self, execution_id: str, success: bool, message: str,
                        error_details: Optional[str] = None) -> ExecutionResult:
    ...
    def cancel_execution(self, execution_id: str, reason: str = "Cancelled by user") -> ExecutionResult:
    ...
    def get_execution_history(self, limit: Optional[int] = None,
                             ...
                             success_only: bool = False) -> List[ExecutionResult]:
