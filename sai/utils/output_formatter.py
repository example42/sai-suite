...
class OutputFormatter:
    ...
    def print_provider_section(self, provider_name: str, command: str, 
                              stdout: Optional[str] = None, stderr: Optional[str] = None,
                              success: bool = True, show_command: bool = True):
    ...
    def print_single_provider_output(self, provider_name: str, command: str,
                                   stdout: Optional[str] = None, stderr: Optional[str] = None,
                                   success: bool = True, show_provider: bool = False):
        ...
        if (self.verbose or not success) and not self.quiet:
            formatted_command = self.format_command(command, provider_name if show_provider else None)
            click.echo(f"Executing: {formatted_command}")
    ...
    def print_execution_summary(self, total_actions: int, successful_actions: int, 
        ...
        if failed_actions == 0:
            ...
            message = f"Executed {successful_actions}/{total_actions} actions ({failed_actions} failed)"
