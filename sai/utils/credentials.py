...
class SecureCredentialStore:
    ...
    def store_credential(
        ...
        try:
            ...
            stored_credential = StoredCredential(
                ...
                metadata={"keys": list(credential_data.keys())},  # Store keys for reference
            )
    ...
    def retrieve_credential(
        self, repository_url: str, credential_type: CredentialType, username: Optional[str] = None
...
class CredentialManager:
    ...
    def store_ssh_key(
        self, repository_url: str, ssh_key_path: str, username: Optional[str] = None
    ) -> bool:
        ...
        return self.secure_store.store_credential(
            repository_url, CredentialType.SSH_KEY, credential_data, username
        )

    def store_access_token(
        self, repository_url: str, token: str, username: Optional[str] = None
    ) -> bool:
        ...
        if self.prefer_keyring:
            ...
            return self.secure_store.store_credential(
                repository_url, CredentialType.ACCESS_TOKEN, credential_data, username
            )
    ...
    def store_username_password(self, repository_url: str, username: str, password: str) -> bool:
        ...
        if self.prefer_keyring:
            ...
            return self.secure_store.store_credential(
                repository_url, CredentialType.USERNAME_PASSWORD, credential_data, username
            )
    ...
    def get_credentials(self, repository_url: str) -> Optional[Dict[str, str]]:
        ...
        # Try SSH key first
        ssh_creds = self.secure_store.retrieve_credential(repository_url, CredentialType.SSH_KEY)
        if ssh_creds:
