...
class RepositoryCache:
    ...
    def __init__(self, config: SaiConfig):
        ...
        self.cache_dir = config.saidata_repository_cache_dir or (
            config.cache_directory / "repositories"
        )
    ...
    def _ensure_cache_directory(self) -> None:
        ...
        try:
            ...
            logger.warning(
                f"Cannot create or write to repository cache directory {self.cache_dir}: {e}"
            )
    ...
    def _save_metadata(self, repositories: Dict[str, RepositoryMetadata]) -> None:
        ...
        try:
            ...
            data = {
                ...
                "repositories": {
                    repo_key: repo_meta.to_dict() for repo_key, repo_meta in repositories.items()
                },
            }
