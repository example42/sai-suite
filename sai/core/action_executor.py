...
from ..models.actions import ActionFile, ActionItem, ActionConfig
from ..core.execution_engine import ExecutionEngine, ExecutionContext, ExecutionResult
...
class ActionExecutor:
    ...
    def execute_action_file(self, action_file: ActionFile, 
                          global_config: Optional[Dict[str, Any]] = None) -> ActionFileExecutionResult:
    ...
    def _execute_actions_sequential(self, actions: List[tuple[str, Union[str, ActionItem]]], 
                                  config: ActionConfig) -> List[ActionExecutionResult]:
    ...
    def _execute_actions_parallel(self, actions: List[tuple[str, Union[str, ActionItem]]], 
                                config: ActionConfig) -> List[ActionExecutionResult]:
