...
from saigen.llm.prompts import PromptManager, PromptTemplate, PromptSection
...
class TestPromptManager:
    ...
    def test_register_custom_template(self):
        ...
        custom_template = PromptTemplate(
            name="custom",
            sections=[
                PromptSection(name="test", template="Test: $software_name")
            ]
        )
    ...
    def test_simple_template_rendering(self):
        ...
        template = PromptTemplate(
            ...
            sections=[
                PromptSection(
                    name="basic",
                    template="Software: $software_name\nProviders: $target_providers"
                )
            ]
        )
    ...
    def test_conditional_sections(self):
        ...
        template = PromptTemplate(
            ...
            sections=[
                PromptSection(
                    name="always",
                    template="Always included: $software_name"
                ),
                PromptSection(
                    name="conditional",
...
@pytest.mark.skipif(
    ...
    pytest.importorskip("openai", reason="OpenAI library not available") is None,
