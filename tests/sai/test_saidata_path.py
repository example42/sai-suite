...
class TestSaidataPath:
    ...
    def test_from_software_name_basic(self):
        ...
        assert saidata_path.hierarchical_path == base_path / "software" / "ap" / "apache" / "default.yaml"
    ...
    def test_from_software_name_normalization(self):
        ...
        assert saidata_path.hierarchical_path == base_path / "software" / "ng" / "nginx" / "default.yaml"
    ...
    def test_from_software_name_with_special_chars(self):
        ...
        assert saidata_path.hierarchical_path == base_path / "software" / "no" / "node-js_v2.0" / "default.yaml"
    ...
    def test_validate_path_wrong_prefix(self):
        ...
        assert any("Prefix directory 'ng' does not match expected 'ap'" in error for error in errors)
    ...
    def test_validate_path_wrong_software_directory(self):
        ...
        assert any("Software directory 'nginx' does not match software name 'apache'" in error for error in errors)
...
class TestHierarchicalPathResolver:
    ...
    def test_get_expected_path_with_base_path(self):
        ...
        assert expected_path.hierarchical_path == custom_base / "software" / "ap" / "apache" / "default.yaml"
    ...
    def test_get_expected_path_default_base(self):
        ...
        assert expected_path.software_name == "apache"
        assert expected_path.hierarchical_path == search_paths[0] / "software" / "ap" / "apache" / "default.yaml"
