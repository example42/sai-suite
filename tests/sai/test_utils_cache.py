...
from sai.utils.cache import CacheManager, ProviderCache
...
class TestProviderCache:
    ...
    def setup_method(self):
        ...
        self.config = SaiConfig(cache_enabled=True, cache_directory=self.cache_dir)
    ...
    def test_cache_expiration(self):
        ...
        with patch("time.time", return_value=time.time() + 2):
            assert self.provider_cache.is_cache_valid(provider_name) is False
    ...
    def test_cleanup_expired_entries(self):
        ...
        self.provider_cache.cache_ttl = 1
        self.provider_cache.update_provider_cache(
            "provider1", {"available": True, "data": "value1"}
        )

        # Set another with longer TTL
        self.provider_cache.cache_ttl = 3600
        self.provider_cache.update_provider_cache(
            "provider2", {"available": True, "data": "value2"}
        )
    ...
    def test_cache_directory_creation(self):
        ...
        new_config = SaiConfig(cache_enabled=True, cache_directory=new_cache_dir)
