...
from sai.core.tarball_repository_handler import TarballOperationResult, ReleaseInfo
...
class TestSaidataRepositoryManager:
    ...
    def test_get_saidata_not_found_retry(self, manager):
        ...
        # Mock the loader
        manager.saidata_loader.load_saidata = Mock(side_effect=[
            SaidataNotFoundError("Not found", "apache"),
            Mock(spec=SaiData)
        ])
    ...
    def test_setup_repository_paths(self, manager):
        ...
        original_paths = manager.config.saidata_paths.copy()
