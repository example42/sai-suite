...
class TestLoggingSetup:
    ...
    def test_setup_root_logging_console_only(self):
        ...
        config = SaiConfig(log_level=LogLevel.INFO, log_file=None)
    ...
    def test_setup_root_logging_with_file(self):
        ...
        try:
            config = SaiConfig(log_level=LogLevel.DEBUG, log_file=log_file)
    ...
    def test_configure_logger_with_file(self):
        ...
        try:
            ...
            configure_logger(
                logger_name, logging.DEBUG, add_console_handler=True, log_file=log_file
            )
...
class TestLoggingIntegration:
    ...
    def test_logging_with_different_levels(self):
        ...
        try:
            config = SaiConfig(log_level=LogLevel.INFO, log_file=log_file)
