...
from sai.cli.main import cli, _execute_software_action, _convert_config_value
from sai.models.config import SaiConfig, LogLevel
from sai.utils.errors import SaiError, ProviderSelectionError, SaidataNotFoundError
...
class TestCLIMain:
    ...
    def test_cli_global_options(self, mock_get_config):
        ...
        result = self.runner.invoke(cli, [
            '--verbose', '--dry-run', '--yes', '--quiet', '--json',
            '--provider', 'test-provider', 'install', 'test-software'
    ...
    @patch('sai.cli.main.get_config')
    def test_install_command_success(self, mock_get_config, mock_execution_engine, 
                                   mock_saidata_loader, mock_provider_loader):
    ...
    def test_multiple_provider_selection(self, mock_get_config, mock_provider_loader):
        ...
        with patch('sai.providers.base.BaseProvider', side_effect=[mock_provider1, mock_provider2]):
            ...
            with patch('sai.cli.main.SaidataLoader'), \
                 patch('sai.cli.main.ExecutionEngine') as mock_engine_class:
...
class TestCLICommands:
    ...
    def test_uninstall_command(self, mock_get_config, mock_execute):
        ...
        result = self.runner.invoke(cli, ['uninstall', 'test-software'])
    ...
    def test_status_command(self, mock_get_config, mock_execute):
        ...
        result = self.runner.invoke(cli, ['status', 'test-software'])
    ...
    def test_info_command(self, mock_get_config, mock_execute):
        ...
        result = self.runner.invoke(cli, ['info', 'test-software'])
    ...
    def test_command_with_timeout(self, mock_get_config, mock_execute):
        ...
        result = self.runner.invoke(cli, ['install', 'test-software', '--timeout', '30'])
    ...
    def test_command_with_no_cache(self, mock_get_config, mock_execute):
        ...
        result = self.runner.invoke(cli, ['install', 'test-software', '--no-cache'])
