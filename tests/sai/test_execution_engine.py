...
from sai.utils.errors import ProviderSelectionError
...
class TestExecutionEngine:
    ...
    def test_dry_run_execution(self, execution_engine, sample_saidata):
        ...
        context = ExecutionContext(
            action="install", software="test-software", saidata=sample_saidata, dry_run=True
        )
    ...
    def test_actual_execution_success(self, mock_popen, execution_engine, sample_saidata):
        ...
        context = ExecutionContext(
            action="install", software="test-software", saidata=sample_saidata, dry_run=False
        )
    ...
    def test_no_available_providers(self, sample_saidata):
        ...
        provider_data = ProviderData(
            ...
            actions={"install": Action(command="unavailable-cmd install")},
        )
