...
class IntegrationTestRunner:
    ...
    def run_basic_integration_tests(self) -> int:
        ...
        test_args = [
            ...
            str(project_root / "tests" / "test_repository_integration_e2e.py::TestRepositoryIntegrationE2E"),
    ...
    def run_offline_mode_tests(self) -> int:
        ...
        test_args = [
            sys.executable, "-m", "pytest",
            str(project_root / "tests" / "test_repository_integration_e2e.py::TestRepositoryOfflineModeIntegration"),
            "-v" if self.verbose else "-q",
            "--tb=short",
            "-m", "integration"
        ]
    ...
    def run_authentication_tests(self) -> int:
        ...
        test_args = [
            sys.executable, "-m", "pytest",
            str(project_root / "tests" / "test_repository_integration_e2e.py::TestRepositoryAuthenticationIntegration"),
            "-v" if self.verbose else "-q",
            "--tb=short",
            "-m", "integration"
        ]
    ...
    def run_performance_tests(self) -> int:
        ...
        test_args = [
            sys.executable, "-m", "pytest",
            str(project_root / "tests" / "test_repository_integration_e2e.py::TestRepositoryPerformanceIntegration"),
            "-v" if self.verbose else "-q",
            "--tb=short",
    ...
    def run_security_tests(self) -> int:
        ...
        test_args = [
            sys.executable, "-m", "pytest",
            str(project_root / "tests" / "test_repository_integration_e2e.py::TestRepositorySecurityIntegration"),
            "-v" if self.verbose else "-q",
            "--tb=short",
            "-m", "integration"
        ]
...
def main():
    ...
    parser.add_argument("--no-cleanup", action="store_true",
                       help="Don't clean up test environment (for debugging)")
