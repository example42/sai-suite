...
from sai.core.saidata_loader import SaidataLoader, SaidataNotFoundError, ValidationResult
...
class TestSaidataLoaderHierarchical:
    ...
    def test_load_saidata_hierarchical_success(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            saidata_file = self.create_hierarchical_structure(base_path, "apache", content)
    ...
    def test_get_expected_hierarchical_path_custom_base(self):
        ...
        assert expected_path.hierarchical_path == custom_base / "software" / "ng" / "nginx" / "default.yaml"
