...
from saigen.models.generation import BatchGenerationResult, GenerationResult
...
class TestBatchCLI:
    ...
    def sample_software_list(self, tmp_path):
        ...
        software_file.write_text("""# Test software list
nginx
redis
postgresql
""")
    ...
    def test_batch_no_input_error(self, runner, mock_config):
        ...
        with runner.isolated_filesystem():
            result = runner.invoke(batch, [], obj={
                'config': mock_config,
                'verbose': False,
                'dry_run': False,
                'llm_provider': None
    ...
    def test_batch_both_inputs_error(self, runner, mock_config, sample_software_list):
        ...
        with runner.isolated_filesystem():
            result = runner.invoke(batch, [
                '--input-file', str(sample_software_list),
                '--software-list', 'nginx'
            ], obj={
                'config': mock_config,
                'verbose': False,
    ...
    def test_batch_category_filter(self, runner, mock_config, tmp_path):
        ...
        software_file.write_text("""# Categorized software list
...
""")
    ...
    def test_batch_successful_execution_dry_run(self, runner, mock_config, sample_software_list, tmp_path):
