...
class TestCLICompletion:
    ...
    def test_complete_provider_names(self):
        ...
        mock_providers = {"apt": Mock(), "brew": Mock(), "yum": Mock(), "pacman": Mock()}
    ...
    def test_complete_action_names(self):
        ...
        mock_provider.get_supported_actions.return_value = [
            "install",
            "uninstall",
            "status",
            "info",
        ...
        with patch("sai.cli.completion.ProviderLoader") as mock_loader_class, patch(
            "sai.providers.base.BaseProvider", return_value=mock_provider
        ):
            mock_loader = Mock()
            mock_loader.load_all_providers.return_value = mock_providers
            mock_loader_class.return_value = mock_loader
