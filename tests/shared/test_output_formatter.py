...
class TestOutputFormatter:
    ...
    def test_create_output_formatter(self):
        ...
        # Mock click context
        ctx = MagicMock()
        ctx.obj = {"quiet": True, "verbose": False, "output_json": False}
...
class TestOutputFormatterIntegration:
    ...
    def test_real_command_sanitization(self):
        ...
        test_cases = [
            ...
            (
                "git clone https://user:pass@github.com/repo.git",
                False,
            ),  # May or may not be redacted
        ]
        ...
        for command, should_be_redacted in test_cases:
            ...
            if should_be_redacted:
                ...
                ), f"Command '{command}' should be sanitized but got: {sanitized}"
            else:
