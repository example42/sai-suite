...
from saigen.llm.provider_manager import LLMProviderManager, ProviderPriority
...
class TestAnthropicProvider:
    ...
    def test_anthropic_import_available(self):
        ...
        try:
            from saigen.llm.providers.anthropic import AnthropicProvider, ANTHROPIC_AVAILABLE
    ...
    def test_anthropic_provider_config_validation(self):
        ...
        with pytest.raises(ConfigurationError):
            AnthropicProvider({
                "api_key": "test-key",
                "temperature": 2.0  # Should be <= 1.0 for Anthropic
            })
...
class TestOllamaProvider:
    ...
    def test_ollama_import_available(self):
        ...
        try:
            from saigen.llm.providers.ollama import OllamaProvider, AIOHTTP_AVAILABLE
...
class TestLLMProviderManager:
    ...
    def test_provider_selection_by_priority(self):
        ...
        with patch.object(LLMProviderManager, 'PROVIDER_REGISTRY', {
            ...
            config_mapped = {
                "openai": config["provider_high"],
                "anthropic": config["provider_low"]
            }
    ...
    async def test_provider_fallback_logic(self):
        ...
        working_provider.generate_saidata = AsyncMock(return_value=LLMResponse(
